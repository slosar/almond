...
\date{July 2026 (v0.4: spin-0 and spin-2, synthesis and exact adjoint;
originally prototyped for spin-0 synthesis in v0.1)}
...
aliasing.  It covers spin-0 and spin-2 fields in both directions
(synthesis and exact adjoint synthesis).  \texttt{ducc0} is the correctness
reference; Almond achieves $\lesssim 10^{-11}$ maximum relative deviation
from it.  This
